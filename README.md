...
Developer OS is the central source of truth for professional identity — not just a portfolio, but a platform that explains _why_ projects were built, architecture decisions, tradeoffs, deployment, and lessons learned.
